...
pub fn create_notification_provider(
    ...
    match provider_type {
        "Telegram" => Ok(Box::new(
            super::telegram_notify::TelegramNotifyProvider::new(token_or_url.to_string()),
        )),
        ...
        "DingTalk" => Ok(Box::new(
            super::dingtalk_notify::DingTalkNotifyProvider::new(
                token_or_url.to_string(),
        ...
        "CustomHTTP" => Ok(Box::new(
            super::custom_http_notify::CustomHttpNotifyProvider::new(
                token_or_url.to_string(),
                config,
            ),
        )),
